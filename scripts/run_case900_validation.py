...
def main():
    parser = argparse.ArgumentParser(); parser.add_argument("--run-modelica", action="store_true"); parser.add_argument("--output", type=Path, default=ROOT / "results/case900"); args = parser.parse_args(); out=args.output; out.mkdir(parents=True, exist_ok=True)
