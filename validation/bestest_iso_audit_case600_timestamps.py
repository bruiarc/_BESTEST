...
def build_audit(iso_mode: str) -> pd.DataFrame:
    ...
    profile = pd.read_csv(ROOT / "results" / "1_iso" / "case600" / "case600_feb1_load_profile.csv")
...
def main() -> None:
    ...
    output = ROOT / "results" / "1_iso" / "case600" / f"case600_feb1_timestamp_alignment_{args.iso_mode}.csv"
